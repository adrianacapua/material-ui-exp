      ...
      <main>
        <div className={classes.container}>
          <Container maxWidth="sm">
            ...
            <Typography variany="h5" align="center" color="textSecondary" paragraph>
              ...
              <Grid item key={index} xs={12} sm={6} md={4}>
                <Card className={classes.card}>
                  ...
                  <CardContent className={classes.cardContent}>
                    ...
                    <Typography>This is a media card. You can use this seciton to describe the content.</Typography>
                  </CardContent>
                  <CardActions>
